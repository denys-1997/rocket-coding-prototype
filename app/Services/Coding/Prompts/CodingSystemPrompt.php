...
final class CodingSystemPrompt
{
    public static function base(): string
    {
        ...
        6. Do NOT provide patient-identifying information back in the response. Strip names,
           DOB, MRN, and any obvious PHI.
        7. If you cannot comply with the schema for any reason, return
           {"encounter_summary": "<explanation>", "cpt_codes": [], "icd10_codes": [],
           "confidence": "low"} — NEVER natural language.
